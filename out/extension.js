...
function activate(context) {
    ...
    context.subscriptions.push(vscode.window.registerWebviewViewProvider("react-state-visualizer.sidebar", sidebarProvider));
    ...
    context.subscriptions.push(vscode.commands.registerCommand("react-state-visualizer.refresh", () => {
        sidebarProvider.scanActiveFile();
    }));
}
